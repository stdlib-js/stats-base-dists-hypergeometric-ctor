...
function Hypergeometric( N, K, n ) {
	...
	if ( !isNonNegativeInteger( N ) ) {
		throw new TypeError( format( '12R93', N ) );
	}
	if ( !isNonNegativeInteger( K ) ) {
		throw new TypeError( format( '12R94', K ) );
	}
	if ( !isNonNegativeInteger( n ) ) {
		throw new TypeError( format( '12R95', n ) );
	}
	if ( K > N ) {
		throw new RangeError( format('12RCw') );
	}
	if ( n > N ) {
		throw new RangeError( format('12RCx') );
	}
	defineProperty( this, 'N', {
		...
		'set': function set( value ) {
			if ( !isNonNegativeInteger( value ) ) {
				throw new TypeError( format( '12R96', value ) );
			}
			if ( K > value ) {
				throw new RangeError( format( '12R97', K, value ) );
			}
			if ( n > value ) {
				throw new RangeError( format( '12R97', n, value ) );
			}
			N = value;
		}
	});
	defineProperty( this, 'K', {
		...
		'set': function set( value ) {
			...
			if ( value > N ) {
				throw new RangeError( format( '12R98', N, value ) );
			}
			K = value;
		}
	});
